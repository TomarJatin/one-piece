...
export default function Footer() {
    ...
    return (
        <footer className={`${theme === "dark" ? "bg-dark border-[#fff]" : "bg-light border-[#000]"} border-t-2 md:py-[40px] py-[20px] md:px-[40px] px-[20px] flex flex-row md:gap-4 gap-2 items-center`}>
